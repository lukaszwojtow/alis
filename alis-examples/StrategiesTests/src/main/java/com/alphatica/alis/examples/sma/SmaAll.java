...
import com.alphatica.alis.trading.strategy.SmaStrategy;
    ...
    private static void checkLength(int length, List<Market> markets, MarketData stooqData) {
        ...
        for (Market market : markets) {
            if (market.getType() == MarketType.STOCK) {
                ...
                Account account = StrategyExecutor.execute(100_000, m, new SmaStrategy(length), new Time(2007_07_09), new Time(2025_01_01));
